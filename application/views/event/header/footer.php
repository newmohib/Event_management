                    ...
                    <ul class="feed-elements list-unstyled">
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url();?>core_templete/img/avatar-5.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url();?>core_templete/img/avatar-2.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url();?>core_templete/img/avatar-3.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url();?>core_templete/img/avatar-1.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="<?php echo base_url();?>core_templete/img/avatar-6.jpg" alt="person" class="img-fluid rounded-circle"></a>
...
<!--    <script src="<?php //echo base_url();?>core_templete/css_js/address_js/address_ajax.js"></script> -->

<!-- for date and time-->

<!--    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.21.0/moment.min.js" type="text/javascript"></script> -->

      <script src="<?php echo base_url();?>core_templete/date_time/build/js/moment.min.js" type="text/javascript"></script>

    <script src="<?php echo base_url();?>core_templete/date_time/build/js/bootstrap-datetimepicker.min.js"></script>
...
<script src="<?php echo base_url();?>ajax/ticket_test.js" type="text/javascript"></script>
