        ...
        <a class="card-link" data-toggle="collapse" href="#collapseOne">
          Event Guid Form
           ...
           <div class="col-12 col-lg-12  col-md-12  col-sm-12">
                <div class="card-body">
                    <?php echo form_open("event/new_event/Event_controller/event_guid_save_controller"); ?>
                      ...
                      <div class="col-lg-12 col-md-12  col-sm-12">
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 col-sm-12 col-mb-12">
                                <label class="label-material">Guid Name</label>
                              </div>
                              <div class="col-lg-12 col-sm-12 col-mb-12">
                               <select name="g_name" class="form-control">
                                   ...
                                   <?php
                                    foreach($event_create['guid_det']->result_array() as $row){   
                      ...
                      <div class="row">
                               <div class="col-lg-6 col-md-6  col-sm-6">
                                <select name="position" class="form-control">
                                   ...
                                   <?php
                                    foreach($event_create['position']->result_array() as $row){   
                        ...
                        <thead>
                          <tr class="table-primary">
                            ...
                            <?php
                                  ...
                                  foreach($event_create['event_guid']->result_array() as $event_row){
