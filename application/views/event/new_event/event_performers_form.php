        ...
        <a class="card-link" data-toggle="collapse" href="#collapseOne">
          Event Performers Form
           ...
           <div class="col-12 col-lg-12  col-md-12  col-sm-12">
                <div class="card-body">
                    <?php echo form_open("event/new_event/Event_controller/event_performers_save_controller"); ?>
                      ...
                      <div class="col-lg-12 col-md-12  col-sm-12">
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 col-sm-12 col-mb-12">
                                <label class="label-material">Performer Name</label>
                              </div>
                              <div class="col-lg-12 col-sm-12 col-mb-12">
                               <select name="p_name" class="form-control">
                                   ...
                                   <?php
                                    foreach($event_create['performers_det']->result_array() as $row){   
                            ...
                            <div class="col-lg-6 col-md-6  col-sm-6">
                              ...
                              <div class="col-lg-12 col-sm-12 col-mb-12">
                               <select name="event" class="form-control">
                                   ...
                                   <?php
                                    foreach($event_create['performers']->result_array() as $row){   
                   ...
                   <hr>
                     <div class="row justify-content-md-center">
                          ...
                          <div class="col-lg-6 col-sm-6 col-mb-6">
                                <div class="form-group-material i-checks ">
                                    <input id="client_signup" type="submit" name="btn_sub_no" class="input-material btn btn-danger btn-lg active" role="button" aria-pressed="true" style="border-radius: 30px;" value="No Thanks">
                        ...
                        <thead>
                          <tr class="table-primary">
                            ...
                            <?php
                                  ...
                                  foreach($event_create['performers']->result_array() as $event_row){
