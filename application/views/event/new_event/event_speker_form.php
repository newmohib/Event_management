        ...
        <a class="card-link" data-toggle="collapse" href="#collapseOne">
          Event Speaker Form
           ...
           <div class="col-12 col-lg-12  col-md-12  col-sm-12">
                <div class="card-body">
                    <?php echo form_open("event/new_event/Event_controller/event_speker_save_controller"); ?>
                      ...
                      <div class="col-lg-12 col-md-12  col-sm-12">
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 col-sm-12 col-mb-12">
                                <label class="label-material">Speaker Name</label>
                              </div>
                              <div class="col-lg-12 col-sm-12 col-mb-12">
                               <select name="name" class="form-control">
                                   ...
                                   <?php
                                    foreach($event_create['speaker_det']->result_array() as $row){   
                            ...
                            <div class="col-lg-6 col-md-6  col-sm-6">
                              ...
                              <div class="col-lg-12 col-sm-12 col-mb-12">
                               <select name="event" class="form-control">
                                   ...
                                   <?php
                                    foreach($event_create['speaker']->result_array() as $row){   
                        ...
                        <thead>
                          <tr class="table-primary">
                            ...
                            <?php
                                  ...
                                  foreach($event_create['speaker']->result_array() as $event_row){
